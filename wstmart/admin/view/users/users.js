...
function initGrid(p){
    ...
    var cols = [
            ...
            {title:'可用金额', name:'userMoney' ,width:60,sortable:true, renderer:function(val,item,rowIndex){
                return '￥'+val;
            }},
            {title:'冻结金额', name:'lockMoney' ,width:60,sortable:true, renderer:function(val,item,rowIndex){
                return '￥'+val;
            }},
            {title:'充值送', name:'rechargeMoney' ,width:60,sortable:true, renderer:function(val,item,rowIndex){
                return '￥'+val;
            }},
