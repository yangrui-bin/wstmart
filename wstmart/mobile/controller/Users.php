...
class Users extends Base{
    ...
    protected $beforeActionList = [
          'checkAuth' =>  ['except'=>'checklogin,login,register,getverify,toregister,forgetpasst,forgetpasss,findpass,getfindphone,getphoneverifycode']// 访问这些except下的方法不需要执行前置操作
    ];
    /**
     * 会员登录页
     */
