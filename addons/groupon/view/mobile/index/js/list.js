...
function goGoods(id){
    location.href=WST.AU('groupon://goods/modetail','id='+id);
}
function searchGoods(){
	var data = $('#wst-search').val();
	location.href = WST.AU('groupon://goods/molists','keyword='+data);
}
