...
<div class="wst-container">
	<div class="wst-empty empty2">
		...
		<div class="button2">
		   ...
		   <a href="<?php echo app('request')->root(true); ?>" class="wst-empty-btn wst-empty-btn1">返回首页</a>
		</div>
	</div>
</div>
