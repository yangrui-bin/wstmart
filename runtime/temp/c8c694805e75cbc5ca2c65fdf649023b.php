               ...
               <table class="wst-table">
                   <tbody>
					<tr class="wst-login-tr">
						...
						<td><input id="loginName" name="loginName" class="ipt wst-forget-input" type="text"  data-rule="用户名 required;remote(post:<?php echo url('home/users/checkFindKey'); ?>)" data-msg-required="请输入用户名" data-tip="请输入用户名"   tabindex="1" value="" autocomplete="off" placeholder="邮箱/用户名/手机号"/></td>
					</tr>
				    <tr class="wst-login-tr">
						...
						<td>
							...
							<img id='verifyImg' class='wst-forget-codeim' src="<?php echo url('home/users/getVerify'); ?>" onclick='javascript:WST.getVerify("#verifyImg")' style="margin-left: 100px;"><span id="verifyCodeTips"></span>
						   	</div>
						   	<label style="float:left;margin:10px 0px 0px 5px;">看不清？<a style="color:#69b7b5;" href="javascript:WST.getVerify('#verifyImg')">换一张</a></label><span id="verify" class="wst-lfloat" style="float: left;margin-left: 120px;margin-top: 2px;"></span>
						</td>
					</tr>
					<tr class="wst-login-tr">
