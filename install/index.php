    ...
    <div style="width:900px;margin:0 auto;float: right;background-color: #fff;">
        ...
        <div id="system_agreement" class="main">
            <div class='content'>
                ...
                <p style='text-indent: 2em'>商淘软件官网：<a target='_blank' href='https://www.shangtao.net'>https://www.shangtao.net</a></p>
                <p style='text-indent: 2em'>WSTMart演示站：<a target='_blank' href='http://demo.wstmart.net'>http://demo.wstmart.net</a></p>
                <p style='text-indent: 2em'>客服 Q Q：153289970</p>
                <p style='text-indent: 2em'>交流QQ群：590755485</p>
                <p style='text-indent: 2em'>交流论坛：<a target='_blank' href='https://www.shangtao.net/forum.html'>https://www.shangtao.net/forum.html</a></p>
        ...
        <div id="system_env" class="main">
            <div class="content" style="padding: 14px 50px 14px 100px;width: 750px;">
                <span class='bold' style='font-size:15px;'>系统环境检查</span>
                <table class="check-env" style='margin-bottom:20px;'>
                    <?php
                        echo '<tr><td class="left">操作系统</td><td><span class="check'.$env_items['os']['status'].'"></span>'.$env_items['os']['current'].((strtolower($env_items['os']['current'])!='linux')?'<span style="float:right;color:#FF9900">(建议使用Linux系统以提升系统性能)</span>':'').'</td></tr>';
        ...
        <div class="main" id="system_success" style="height: 536px;">
            <div class="content" style='text-align:center;background-color: #faffbd;width: 500px;height: 300px;margin-top: 50px;'>
                <div style="margin: 30px 0;">
                    <span style="display:inline-block;margin-top:10px;">
                       <span style="font-size:24px;color: #178cdc;"> 恭喜，WSTMart已安装成功&nbsp;!</span><br /><br />
                        安装成功后，建议删除install目录
                    </span><br /><br />
                    <div id='checkRoute'></div><br />
