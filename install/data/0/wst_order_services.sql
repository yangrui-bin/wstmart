...
CREATE TABLE `wst_order_services` (
  ...
  `shopRejectType` tinyint(4) unsigned NOT NULL DEFAULT '0' COMMENT '商家拒收类型,数据由基础数据类型里取',
  ...
  `serviceStatus` tinyint(4) unsigned NOT NULL DEFAULT '0' COMMENT '状态备注：0：待商家审核  1：等待用户发货 2：商家等待收货 3：商家确认收货  4：等待商家发货  5：确认收货  6：完成退款/退货',
